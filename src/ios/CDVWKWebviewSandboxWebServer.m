...
- (void) pluginInitialize {
    ...
    [self.server addGETHandlerForBasePath:@"/" directoryPath:[NSHomeDirectory() stringByAppendingString:@"/Library/NoCloud/app/www"] indexFilename:@"index.html" cacheAge:3600 allowRangeRequests:YES];
